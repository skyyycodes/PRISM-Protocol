...
- [System Architecture](./system-architecture.md) explains the five protocol domains.
- [Core Protocol Layer](./core-protocol-layer.md) defines vaults, tranches, waterfalls, and default resolution.
- [Financial Model](./financial-model.md) explains NAV, yield, loss, and accounting integrity.
- [Core Operations](./core-operations.md) walks through deposit, yield accrual, credit events, withdrawal, and trading.
- [Market Design](./market-design.md) explains AMM liquidity and price discovery.
- [Security & Controls](./security-controls.md) covers access control, pause behavior, and deterministic execution.
