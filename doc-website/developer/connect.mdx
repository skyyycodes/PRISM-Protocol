...
```text
┌──────────────────┐     ┌──────────────────┐     ┌──────────────────────┐
│ @solana/web3.js  │────▶│ @coral-xyz/anchor│────▶│ @prism-protocol/sdk  │
...
<Steps>
  ...
  <Step title="Load both programs">
    ...
    import { prismCoreIdl, prismAmmIdl } from '@prism-protocol/sdk';
...
```typescript
import { getConfigPda, getVaultPda } from '@prism-protocol/sdk';
...
```typescript
import { TrancheKind, getTranchePda } from '@prism-protocol/sdk';
...
```typescript
import { Q64_ONE, formatNavQ } from '@prism-protocol/sdk';
