...
```bash npm
npm install prismprotocol-sdk @coral-xyz/anchor @solana/web3.js @solana/spl-token
```
...
```bash yarn
yarn add prismprotocol-sdk @coral-xyz/anchor @solana/web3.js @solana/spl-token
```
</CodeGroup>
