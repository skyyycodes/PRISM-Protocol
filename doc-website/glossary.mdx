...
The highest-risk tranche. Alpha targets 15% yield and absorbs losses first.
...
The deterministic payment order used to distribute incoming yield. Prime receives its 5% target first, then Core receives 8%, then Alpha receives 15%.
