...
export function PricingSection() {
  ...
  return (
    <section id="pricing" ref={sectionRef} className="relative min-h-screen pt-20 pb-10 lg:pt-24 lg:pb-12 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        {/* Header - Dramatic offset */}
        <div className="grid lg:grid-cols-12 gap-6 mb-8 lg:mb-10">
          <div className="lg:col-span-7">
            <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground mb-5">
              <span className="w-12 h-px bg-foreground/30" />
              Pricing
            </span>
            <h2 className={`text-6xl md:text-7xl lg:text-[104px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          <div className="lg:col-span-5 relative p-0 h-56 lg:h-auto">
            {/* Whale image */}
        ...
        <div className={`mt-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 pt-5 border-t border-foreground/10 transition-all duration-1000 delay-500 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
