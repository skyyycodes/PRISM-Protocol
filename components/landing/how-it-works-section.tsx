  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="relative mb-6 grid lg:grid-cols-2 gap-4 lg:gap-10 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-8">
            ...
            <h2 className={`text-5xl md:text-6xl lg:text-[104px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Waterfall.</span>
              <span className="block text-white/10">Reprice.</span>
            </h2>
          </div>
