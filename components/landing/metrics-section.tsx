...
const metrics = [
  ...
  { 
    ...
    prefix: "",
    label: "AMM fee",
    sublabel: "constant-product pools",
  },
];
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-3 gap-4 lg:gap-5">
          ...
          <div className={`lg:col-span-1 bg-foreground/[0.02] border border-foreground/10 p-6 lg:p-8 transition-all duration-700 ${
            ...
            <div className="mb-4">
              <DotGraph color="white" height={28} freq1={0.28} freq2={0.09} freqT={0.5} speed={0.018} baseline={0.35} amplitude={0.55} />
            </div>
            <div className="text-base text-foreground mb-1">{metrics[0].label}</div>
          ...
          {metrics.slice(1).map((metric, index) => (
            <div
              key={metric.label}
              className={`bg-foreground/[0.02] border border-foreground/10 p-6 lg:p-7 flex flex-col items-start justify-between gap-4 transition-all duration-700 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
              }`}
            ...
            >
              <div className="w-full">
                ...
                <div className="text-base text-foreground mb-2">{metric.label}</div>
                <DotGraph
